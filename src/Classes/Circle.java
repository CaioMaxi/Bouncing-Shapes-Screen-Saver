...
public class Circle extends Shape{
    //    Constructor:
    public Circle(Color color1, Color color2, int width, int xPosition, int yPosition, int xSpeed, int ySpeed) {
...
//        Uses Graphic to draw and fill the square
        g.fillOval(this.getxPosition(), this.getyPosition(), this.getShapeWidth(), this.getShapeWidth());
    }
