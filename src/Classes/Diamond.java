...
public class Diamond extends Shape{
    ...
    //    Constructor:
    public Diamond(Color color1, Color color2, int[] x, int[] y, int xSpeed, int ySpeed) {
...
//        This is to update the rectangle. Extracted from Gemini AI
        this.setBounds(getCoordX()[3], getCoordY()[0], getCoordX()[1] - getCoordX()[3], getCoordY()[2] - getCoordY()[0]);
    }
...
//    direction accordingly.
    public void moveShape(ScreenSaver ss){
        int[] newX = {getCoordX()[0] + this.getxSpeed(), getCoordX()[1] + this.getxSpeed(), getCoordX()[2] + this.getxSpeed(), getCoordX()[3] + this.getxSpeed()};
        this.setCoordX(newX);
        int[] newY = {getCoordY()[0] + this.getySpeed(), getCoordY()[1] + this.getySpeed(), getCoordY()[2] + this.getySpeed(), getCoordY()[3] + this.getySpeed()};
        this.setCoordY(newY);

        if (this.getCoordX()[1] >= ss.getWidth() || this.getCoordX()[3] < 0) {
