...
public class Line extends Shape {
    //    Constructor:
    public Line(Color color1, Color color2, int height, int width, int xPosition, int yPosition, int xSpeed, int ySpeed) {
...
//        Uses Graphic to draw and fill the square
        g.drawLine(this.getxPosition(), this.getyPosition(), this.getxPosition() + this.getShapeWidth(), this.getyPosition() + this.getShapeHeight());
    }
...
//    direction accordingly.
    public void moveShape(ScreenSaver ss) {
        ...
        if (this.getyPosition() > ss.getHeight() - this.getShapeHeight() || this.getyPosition() < 0) {
